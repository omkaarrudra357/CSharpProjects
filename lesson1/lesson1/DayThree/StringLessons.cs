...
namespace LessonOne.DayThree
{
    internal class StringLessons
    {
        ...
        public static void DemoC()
        {
            ...
            Console.WriteLine("Word cunt "+ words.Count());
        ...
        {
            String firstString = "Tom and Jerry are goods Friends";
            String stringInUpper = firstString.ToUpper();
            Console.WriteLine("firststring: "+ firstString);
            Console.WriteLine("string in upper: "+ stringInUpper);
            String stringInLower = firstString.ToLower();
            Console.WriteLine("firststring: "+ firstString);
            Console.WriteLine("string in lower: "+ stringInLower);
        }
